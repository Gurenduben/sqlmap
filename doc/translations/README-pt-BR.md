...
![Imagem](https://raw.github.com/wiki/gurenduben/sqlmap/images/sqlmap_screenshot.png)

Você pode visitar a [coleção de imagens](https://github.com/gurenduben/sqlmap/wiki/Screenshots) que demonstra alguns dos recursos apresentados na wiki.

Instalação
----

Você pode baixar o arquivo tar mais recente clicando [aqui](https://github.com/gurenduben/sqlmap/tarball/master) ou o arquivo zip mais recente clicando [aqui](https://github.com/gurenduben/sqlmap/zipball/master).

De preferência, você pode baixar o sqlmap clonando o repositório [Git](https://github.com/gurenduben/sqlmap):
...
Para ter uma visão geral dos recursos do sqlmap, lista de recursos suportados e a descrição de todas as opções, juntamente com exemplos, aconselhamos que você consulte o [manual do usuário](https://github.com/gurenduben/sqlmap/wiki).

Links
----

* Homepage: https://sqlmap.org
* Download: [.tar.gz](https://github.com/gurenduben/sqlmap/tarball/master) ou [.zip](https://github.com/gurenduben/sqlmap/zipball/master)
...
* Manual do Usuário: https://github.com/gurenduben/sqlmap/wiki
* Perguntas frequentes (FAQ): https://github.com/gurenduben/sqlmap/wiki/FAQ
...
* Pesquisa: https://www.sekuripy.hr/labs/sqlmap/#research
* Imagens: https://github.com/gurenduben/sqlmap/wiki/Screenshots
