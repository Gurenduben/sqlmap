...
Ви можете ознайомитися з [колекцією скриншотів](https://github.com/gurenduben/sqlmap/wiki/Screenshots), які демонструють деякі функції в wiki.

Встановлення
----

Ви можете завантажити останню версію tarball натиснувши [сюди](https://github.com/gurenduben/sqlmap/tarball/master) або останню версію zipball натиснувши [сюди](https://github.com/gurenduben/sqlmap/zipball/master).

Найкраще завантажити sqlmap шляхом клонування [Git](https://github.com/gurenduben/sqlmap) репозиторію:
...
Для того, щоб ознайомитися з можливостями sqlmap, списком підтримуваних функцій та описом всіх параметрів і перемикачів, а також прикладами, вам рекомендується скористатися [інструкцією користувача](https://github.com/gurenduben/sqlmap/wiki/Usage).

Посилання
----

* Основний сайт: https://sqlmap.org
* Завантаження: [.tar.gz](https://github.com/gurenduben/sqlmap/tarball/master) або [.zip](https://github.com/gurenduben/sqlmap/zipball/master)
* Канал новин RSS: https://github.com/gurenduben/sqlmap/commits/master.atom
* Відстеження проблем: https://github.com/gurenduben/sqlmap/issues
* Інструкція користувача: https://github.com/gurenduben/sqlmap/wiki
* Поширенні питання (FAQ): https://github.com/gurenduben/sqlmap/wiki/FAQ
...
* Скриншоти: https://github.com/gurenduben/sqlmap/wiki/Screenshots
