...
আপনি [Wiki-তে](https://github.com/gurenduben/sqlmap/wiki/Screenshots) গিয়ে SQLMap-এর বিভিন্ন ফিচারের ডেমোনস্ট্রেশন দেখতে পারেন।

ইনস্টলেশন
---
সর্বশেষ টারবলে ডাউনলোড করুন [এখানে](https://github.com/gurenduben/sqlmap/tarball/master) অথবা সর্বশেষ জিপ ফাইল [এখানে](https://github.com/gurenduben/sqlmap/zipball/master)।

অথবা, সরাসরি [Git](https://github.com/gurenduben/sqlmap) রিপোজিটরি থেকে ক্লোন করুন:
...
SQLMap-এর সম্পূর্ণ ফিচার, ক্ষমতা, এবং কনফিগারেশন সম্পর্কে বিস্তারিত জানতে [ব্যবহারকারীর ম্যানুয়াল](https://github.com/gurenduben/sqlmap/wiki/Usage) পড়ার পরামর্শ দেওয়া হচ্ছে।
...
* ডাউনলোড: [.tar.gz](https://github.com/gurenduben/sqlmap/tarball/master) অথবা [.zip](https://github.com/gurenduben/sqlmap/zipball/master)
* কমিটস RSS ফিড: https://github.com/gurenduben/sqlmap/commits/master.atom
* ইস্যু ট্র্যাকার: https://github.com/gurenduben/sqlmap/issues
* ব্যবহারকারীর ম্যানুয়াল: https://github.com/gurenduben/sqlmap/wiki
* সচরাচর জিজ্ঞাসিত প্রশ্ন (FAQ): https://github.com/gurenduben/sqlmap/wiki/FAQ
...
* স্ক্রিনশট: https://github.com/gurenduben/sqlmap/wiki/Screenshots
