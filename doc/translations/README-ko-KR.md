...
또는, wiki에 나와있는 몇몇 기능을 보여주는 [스크린샷 모음](https://github.com/gurenduben/sqlmap/wiki/Screenshots) 을 방문하실 수 있습니다.

설치
----

[여기](https://github.com/gurenduben/sqlmap/tarball/master)를 클릭하여 최신 버전의 tarball 파일, 또는 [여기](https://github.com/gurenduben/sqlmap/zipball/master)를 클릭하여 최신 zipball 파일을 다운받으실 수 있습니다.

가장 선호되는 방법으로, [Git](https://github.com/gurenduben/sqlmap) 저장소를 복제하여 sqlmap을 다운로드 할 수 있습니다:
...
sqlmap의 능력, 지원되는 기능과 모든 옵션과 스위치들의 목록을 예제와 함께 보려면, [사용자 매뉴얼](https://github.com/gurenduben/sqlmap/wiki/Usage)을 참고하시길 권장드립니다.

링크
----

* 홈페이지: https://sqlmap.org
* 다운로드: [.tar.gz](https://github.com/gurenduben/sqlmap/tarball/master) or [.zip](https://github.com/gurenduben/sqlmap/zipball/master)
* RSS 피드 커밋: https://github.com/gurenduben/sqlmap/commits/master.atom
* Issue tracker: https://github.com/gurenduben/sqlmap/issues
* 사용자 매뉴얼: https://github.com/gurenduben/sqlmap/wiki
* 자주 묻는 질문 (FAQ): https://github.com/gurenduben/sqlmap/wiki/FAQ
...
* 스크린샷: https://github.com/gurenduben/sqlmap/wiki/Screenshots
