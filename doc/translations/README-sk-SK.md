...
![snímka obrazovky](https://raw.github.com/wiki/gurenduben/sqlmap/images/sqlmap_screenshot.png)

Môžete navštíviť [zbierku snímok obrazovky](https://github.com/gurenduben/sqlmap/wiki/Screenshots), ktorá demonštruuje niektoré funkcie na wiki.

Inštalácia
----

Najnovší tarball si môžete stiahnuť kliknutím [sem](https://github.com/gurenduben/sqlmap/tarball/master) alebo najnovší zipball kliknutím [sem](https://github.com/gurenduben/sqlmap/zipball/master).

Najlepšie je stiahnuť sqlmap naklonovaním [Git](https://github.com/gurenduben/sqlmap) repozitára:
...
Ak chcete získať prehľad o možnostiach sqlmap, zoznam podporovaných funkcií a opis všetkých možností a prepínačov spolu s príkladmi, odporúčame vám nahliadnuť do [Používateľskej príručky](https://github.com/gurenduben/sqlmap/wiki/Usage).

Linky
----

* Domovská stránka: https://sqlmap.org
* Stiahnutia: [.tar.gz](https://github.com/gurenduben/sqlmap/tarball/master) alebo [.zip](https://github.com/gurenduben/sqlmap/zipball/master)
* Zdroje RSS Commits: https://github.com/gurenduben/sqlmap/commits/master.atom
* Sledovač problémov: https://github.com/gurenduben/sqlmap/issues
* Používateľská príručka: https://github.com/gurenduben/sqlmap/wiki
* Často kladené otázky (FAQ): https://github.com/gurenduben/sqlmap/wiki/FAQ
...
* Snímky obrazovky: https://github.com/gurenduben/sqlmap/wiki/Screenshots
