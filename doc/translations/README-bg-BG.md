...
![Снимка на екрана](https://raw.github.com/wiki/gurenduben/sqlmap/images/sqlmap_screenshot.png)

Можете да посетите [колекцията от снимки на екрана](https://github.com/gurenduben/sqlmap/wiki/Screenshots), показващи някои  функции, качени на wiki.

Инсталиране
----

Може да изтеглине най-новите tar архиви като кликнете [тук](https://github.com/gurenduben/sqlmap/tarball/master) или най-новите zip архиви като кликнете [тук](https://github.com/gurenduben/sqlmap/zipball/master).

За предпочитане е да изтеглите sqlmap като клонирате [Git](https://github.com/gurenduben/sqlmap) хранилището:
...
За да разберете възможностите на sqlmap, списък на поддържаните функции и описание на всички опции, заедно с примери, се препоръчва да се разгледа [упътването](https://github.com/gurenduben/sqlmap/wiki/Usage).

Връзки
----

* Начална страница: https://sqlmap.org
* Изтегляне: [.tar.gz](https://github.com/gurenduben/sqlmap/tarball/master) or [.zip](https://github.com/gurenduben/sqlmap/zipball/master)
* RSS емисия: https://github.com/gurenduben/sqlmap/commits/master.atom
* Проследяване на проблеми и въпроси: https://github.com/gurenduben/sqlmap/issues
* Упътване: https://github.com/gurenduben/sqlmap/wiki
* Често задавани въпроси (FAQ): https://github.com/gurenduben/sqlmap/wiki/FAQ
...
* Снимки на екрана: https://github.com/gurenduben/sqlmap/wiki/Screenshots
