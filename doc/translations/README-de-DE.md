...
Du kannst eine [Sammlung von Screenshots](https://github.com/gurenduben/sqlmap/wiki/Screenshots), die einige der Funktionen demonstrieren, auf dem Wiki einsehen.

Installation
---

[Hier](https://github.com/gurenduben/sqlmap/tarball/master) kannst du das neueste TAR-Archiv herunterladen und [hier](https://github.com/gurenduben/sqlmap/zipball/master) das neueste ZIP-Archiv.

Vorzugsweise kannst du sqlmap herunterladen, indem du das [GIT](https://github.com/gurenduben/sqlmap) Repository klonst:
...
Ein Probelauf ist [hier](https://asciinema.org/a/46601) zu finden. Um einen Überblick über sqlmap's Fähigkeiten, unterstütze Funktionen und eine Erklärung aller Optionen und Switches, zusammen mit Beispielen, zu erhalten, wird das [Benutzerhandbuch](https://github.com/gurenduben/sqlmap/wiki/Usage) empfohlen.
...
* Problemverfolgung: https://github.com/gurenduben/sqlmap/issues
* Benutzerhandbuch: https://github.com/gurenduben/sqlmap/wiki
* Häufig gestellte Fragen (FAQ): https://github.com/gurenduben/sqlmap/wiki/FAQ
...
* Forschung: https://www.sekuripy.hr/labs/sqlmap/#research
