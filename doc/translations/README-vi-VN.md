...
Bạn có thể truy cập vào [bộ sưu tập ảnh chụp màn hình](https://github.com/gurenduben/sqlmap/wiki/Screenshots) - nơi trình bày một số tính năng có thể tìm thấy trong wiki.

Cài đặt
----


Bạn có thể tải xuống tập tin nén tar mới nhất bằng cách nhấp vào [đây](https://github.com/gurenduben/sqlmap/tarball/master) hoặc tập tin nén zip mới nhất bằng cách nhấp vào [đây](https://github.com/gurenduben/sqlmap/zipball/master).

Tốt hơn là bạn nên tải xuống sqlmap bằng cách clone về repo [Git](https://github.com/gurenduben/sqlmap):
...
Để có cái nhìn tổng quan về sqlmap, danh sách các tính năng được hỗ trợ và mô tả về tất cả các tùy chọn, cùng với các ví dụ, bạn nên tham khảo [hướng dẫn sử dụng](https://github.com/gurenduben/sqlmap/wiki/Usage) (Tiếng Anh).

Liên kết
----

* Trang chủ: https://sqlmap.org
* Tải xuống: [.tar.gz](https://github.com/gurenduben/sqlmap/tarball/master) hoặc [.zip](https://github.com/gurenduben/sqlmap/zipball/master)
* Nguồn cấp dữ liệu RSS về commits: https://github.com/gurenduben/sqlmap/commits/master.atom
* Theo dõi issue: https://github.com/gurenduben/sqlmap/issues
* Hướng dẫn sử dụng: https://github.com/gurenduben/sqlmap/wiki
* Các câu hỏi thường gặp (FAQ): https://github.com/gurenduben/sqlmap/wiki/FAQ
...
* Ảnh chụp màn hình: https://github.com/gurenduben/sqlmap/wiki/Screenshots
